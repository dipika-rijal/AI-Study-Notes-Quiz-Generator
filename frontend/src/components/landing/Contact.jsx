      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid overflow-hidden rounded-[36px] border border-white/10 bg-white shadow-2xl shadow-black/30 md:grid-cols-[.85fr_1.15fr]">
          <div className="bg-[#674356] p-8 md:p-12" style={{ backgroundImage: "none" }}>
            ...
            <p className="mt-4 max-w-sm leading-7 text-[#b7bbc3]">Send us a message. This form is ready on the page now; message delivery will be connected tomorrow.</p>
          </div>
          <form onSubmit={handleSubmit} className="p-8 md:p-12">
            ...
            {submitted && <p className="mt-4 rounded-xl bg-[#edfff6] px-4 py-3 text-sm font-semibold text-emerald-700">Thanks! Your message is saved in this form preview. Sending will be enabled tomorrow.</p>}
            <button type="submit" className="mt-6 inline-flex items-center gap-2 rounded-xl bg-[#171a14] px-5 py-3 font-black text-white shadow-lg shadow-black/20 transition hover:-translate-y-0.5 hover:bg-[#30362a]"><Send size={17} /> Send message</button>
          </form>
        </div>
      </div>
    </section>
